...
def change_details():
    ...
    cursor.execute(
        "INSERT INTO users (id, email, password, name, dob, pr_squat, pr_bench, pr_deadlift) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        (id, email, password, name, dob, pr_squat, pr_bench, pr_deadlift)
    )
...
info_title = ttk.Label(root, text="Edit Info:", font=("Helvetica", 30))  # underline
